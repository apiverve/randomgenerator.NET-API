...
namespace APIVerve
{
    public class RandomDataGeneratorAPIClient
    {
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, randomgeneratorQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(randomgeneratorQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(randomgeneratorQueryOptions options)
        {

...
namespace APIVerve
{
    public class RandomDataGeneratorAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/randomgenerator";
        ...
        public RandomDataGeneratorAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public RandomDataGeneratorAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, RandomDataGeneratorQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(RandomDataGeneratorQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(RandomDataGeneratorQueryOptions options)
        {
